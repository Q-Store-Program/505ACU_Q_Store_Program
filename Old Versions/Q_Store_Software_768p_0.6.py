...
def Q_Store_Software_06():
    ...
    def AACMemberOptions():
        ...
        def changeRankOptions():
            ...
            namesListListbox = Listbox(listboxFrame, bg= "#292929", fg= "Silver", width= 25, height= 20, font= standardFont)
    ...
    def orderingOptions():
        ...
        def storesList():
            ...
            storesListListbox = Listbox(listboxFrame, bg= "#292929", fg= "Silver", width= 30, height= 9, font= standardFont)
            storesListListbox.pack(side=LEFT)
            ...
            #Creates a listbox
            ordersListbox = Listbox(listboxFrameTwo, bg= "#292929", fg= "Silver", width= 30, height= 9, font= standardFont)
